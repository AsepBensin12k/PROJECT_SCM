    ...
    <div class="max-w-4xl mx-auto py-8 px-4">
        <div class="bg-white rounded-xl shadow-md p-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 mt-2">Perbarui informasi bahan baku</p>
            </div>

            <!-- Form -->
            <form action="{{ route('koordinator.materials.update', $material->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mt-8 flex justify-end space-x-4">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save mr-2"></i> Update Bahan Baku
                    </button>
                </div>
            </form>
        </div>
