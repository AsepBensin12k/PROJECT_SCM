            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('koordinator.dashboard') }}"
                        class="text-base font-bold text-white tracking-tight hover:text-amber-100 transition-all duration-300">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('koordinator.dashboard') }}"
                        class="group flex items-center space-x-2 bg-white/15 hover:bg-white/25 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/20 hover:border-white/40 transition-all duration-300">
                        <i
                            class="fas fa-arrow-left text-white text-sm group-hover:-translate-x-1 transition-transform duration-300"></i>
                        <span class="text-white text-sm font-semibold">Kembali ke Dashboard</span>
                    </a>

                    <!-- User Name -->
                    <div
                        class="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/20 shadow-lg">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-800">
                                Rp
                                {{ number_format(
                                    $materials->sum(function ($material) {
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase">Nama Bahan
                                </th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase">Supplier
                                </th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase">Satuan</th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase">Stok</th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase">Harga</th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase">Total Nilai
                                </th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($materials as $material)
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="px-6 py-4">{{ $material->supplier->name ?? '-' }}</td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">Rp {{ number_format($material->price, 0, ',', '.') }}</td>
                                    <td class="px-6 py-4">
                                        Rp {{ number_format($material->price * $material->stock, 0, ',', '.') }}
                                    </td>
                                </tr>
