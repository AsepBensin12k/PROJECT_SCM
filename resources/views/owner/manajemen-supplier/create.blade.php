...
<head>
    ...
    <title>Tambah Supplier - RO JEMBER</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <span class="text-white font-bold text-lg tracking-tight">Tambah Supplier</span>
            ...
            <div class="mb-6 flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 flex items-center">
                        <i class="fas fa-user-plus text-purple-600 mr-3"></i> Tambah Supplier
                    </h1>
                    <p class="text-gray-500 text-sm mt-1">Isi form berikut untuk menambahkan supplier baru</p>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="origin" id="origin"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all"
                            placeholder="Masukkan asal supplier" value="{{ old('origin') }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="contact" id="contact"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all"
                            placeholder="Masukkan nomor atau email" value="{{ old('contact') }}">
                    </div>
                ...
                <div class="flex">
                    ...
                    <div>
                        ...
                        <ul class="text-sm text-purple-700 mt-1 list-disc list-inside space-y-1">
                            <li>Pastikan semua field wajib diisi dengan benar</li>
                            <li>Status “Aktif” menandakan supplier siap digunakan</li>
                            <li>Gunakan tombol kembali untuk membatalkan proses</li>
                        </ul>
                    </div>
                </div>
            </div>
